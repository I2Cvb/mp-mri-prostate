...
fresults = '/data/prostate/results/mp-mri-prostate/exp-4/combine/results.pkl'
...
ax.plot(mean_fpr, avg_tpr,
        label=r'Fine tune Random Forest - AUC $= {:1.3f} \pm {:1.3f}$'.format(
...
# Save the plot
plt.savefig('results/exp-4/combine_all.pdf',
