...
fresults = '/data/prostate/results/mp-mri-prostate/exp-1/t2w/results.pkl'
...
fresults = '/data/prostate/results/mp-mri-prostate/exp-1/adc/results.pkl'
results = joblib.load(fresults)
...
# Save the plot
plt.savefig('results/exp-1/t2w_adc.pdf',
