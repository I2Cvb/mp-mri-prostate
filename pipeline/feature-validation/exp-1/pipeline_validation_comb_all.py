...
fresults = '/data/prostate/results/mp-mri-prostate/exp-1/all/results.pkl'
...
fresults = '/data/prostate/results/mp-mri-prostate/exp-1/stacking/results.pkl'
results = joblib.load(fresults)
...
# Save the plot
plt.savefig('results/exp-1/comb_all.pdf',
