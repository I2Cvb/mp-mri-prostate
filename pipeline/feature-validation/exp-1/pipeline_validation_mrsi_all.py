...
fresults = '/data/prostate/results/mp-mri-prostate/exp-1/mrsi-qua/results.pkl'
...
fresults = '/data/prostate/results/mp-mri-prostate/exp-1/mrsi-qua-int/results.pkl'
results = joblib.load(fresults)
...
fresults = '/data/prostate/results/mp-mri-prostate/exp-1/mrsi-qua-nofitting/results.pkl'
results = joblib.load(fresults)
