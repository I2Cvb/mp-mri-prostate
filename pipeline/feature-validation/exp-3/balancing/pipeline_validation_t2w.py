...
fresults = '/data/prostate/results/mp-mri-prostate/exp-3/balancing/t2w/results.pkl'
...
#plt.title(r'T2W classification with different balancing method')

handles, labels = ax.get_legend_handles_labels()
lgd = ax.legend(handles, labels, loc='lower right')#,
                #bbox_to_anchor=(1.4, 0.1))
# Save the plot
plt.savefig('results/exp-3/balancing/t2w.pdf',
