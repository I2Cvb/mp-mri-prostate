...
fresults = '/data/prostate/results/mp-mri-prostate/exp-3/dce/ica/results.pkl'
...
plt.title(r'DCE classification with ICA decomposition with different $\lambda$')

handles, labels = ax.get_legend_handles_labels()
lgd = ax.legend(handles, labels, loc='lower right')#,
                #bbox_to_anchor=(1.4, 0.1))
# Save the plot
plt.savefig('results/exp-3/dce_ica.pdf',
