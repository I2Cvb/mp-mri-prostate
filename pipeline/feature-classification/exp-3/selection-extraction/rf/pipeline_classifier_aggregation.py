...
# Balanced path
path_balanced = '/data/prostate/balanced/mp-mri-prostate/exp-3/nm3'
...
path_store = '/data/prostate/results/mp-mri-prostate/exp-3/selection-extraction/rf/aggregation'
