...
in cylindrical space using centre --- from standalone file.
"""
...
path_store = '/data/prostate/extraction/mp-mri-prostate/spatial-position-cylindrical'
...
for id_p, (p_t2w, p_gt) in enumerate(zip(path_patients_list_t2w,
    ...
    spe = SpatialExtraction(t2w_mod, kind='position',
