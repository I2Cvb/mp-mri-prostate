"""
This pipeline is intended to extract spatial information --- position
in euclidean space using centre --- from standalone file.
"""
...
path_store = '/data/prostate/extraction/mp-mri-prostate/spatial-position-euclidean'
...
for id_p, (p_t2w, p_gt) in enumerate(zip(path_patients_list_t2w,
    ...
    spe = SpatialExtraction(t2w_mod, kind='position', coord_system='euclidean',
                            reference='centre')
